...
ORCA PED Analyzer has been tested with **ORCA 6.0.1**, although it should also work with earlier and later ORCA versions provided that the relevant output formats remain compatible.
