...
# 1. Main features of version 1.1.4
...
Avogadro numbers vibration entries sequentially. Version 1.1.4 keeps the preceding translational/rotational entries in the CJSON so that the number displayed by Avogadro matches the ORCA/PED Hessian mode number. For a typical nonlinear molecule:
