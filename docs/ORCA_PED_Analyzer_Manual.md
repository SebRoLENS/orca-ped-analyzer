...
# 1. Main features of version 2.10.2
...
Avogadro numbers vibration entries sequentially. Version 2.10.2 keeps the preceding translational/rotational entries in the CJSON so that the number displayed by Avogadro matches the ORCA/PED Hessian mode number. For a typical nonlinear molecule:
